...
c      fit2name='fit2'//aname
	...
	write(88,*)'unset clip points'
	write(88,*)'set clip one'
	write(88,*)'unset clip two'
...
c	write(88,*)'unset style line'
	...
	write(88,*)'set style data points'
	write(88,*)'set style function lines'
	...
	write(88,*)'set tics scale default'
	...
	write(88,*)'unset x2tics'
	write(88,*)'unset y2tics'
...
c       write(88,*)'set logscale y'
 ...
 888  format(1x,'plot ''',a,''' with errorbars linewidth 1,''',a,
     & ''' with lines linestyle 1 linewidth 3,''',a,
     & ''' with lines linestyle 1 linewidth 3')         
...
c 222   format(1x,'set label "chi" at 0.5,0.5')
 ...
 588  format(1x,'plot ''',a,''' with errorbars linewidth 1,''',a,
     & ''' with lines linestyle 1 linewidth 3') 
 9991 write(88,*)'exit gnuplot'
      close(88)

      write(6,*)'Gnuplot files (=> pdf): plot1.pl and plot2.pl'
